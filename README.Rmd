...
> `r Authors` (2022). *`r Title`* Peer Community Journal 2: e77. <https://doi.org/10.24072/pcjournal.204>
...
> `r Authors` (`r format(Sys.Date(), "%Y")`). Compendium of code and data for *`r Title`* Online at <https://doi.org/10.5281/zenodo.4439450>
...
- [`*.dat` files](/Python_analysis/derived_data/preprocessing): pre-processed raw data, used as input to the models.  
...
The [Dockerfile](/Dockerfile) contains the instruction to build the Docker image for the Python analysis. See section [How to run in your browser or download and run locally](#how-to-run-in-your-browser-or-download-and-run-locally) for details.
