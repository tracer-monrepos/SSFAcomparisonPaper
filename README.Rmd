...
> `r Authors` (year). *`r Title`* Journal. DOI.

# How to cite

Please cite this compendium as:

> `r Authors` (`r format(Sys.Date(), "%Y")`). Compendium of code and data for *`r Title`* Accessed date. Online at <https://doi.org/10.5281/zenodo.4439450>
