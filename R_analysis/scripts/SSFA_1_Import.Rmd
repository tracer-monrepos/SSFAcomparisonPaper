...
### Edit column "Name"
```{r}
# Remove ".sur" at the end of the name and keep only the part of the name after " --- "
...
- $\ge$ 20% NMP: "20-100%" (these surfaces were not acquired correctly and should not be used) 
