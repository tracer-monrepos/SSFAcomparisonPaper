...
Surfaces with more than 20% NMP are likely the result of issues during acquisition and must be excluded. While surfaces having more than 10% (or 5%) NMP can also be problematic, they are still included in the summary statistics. Nevertheless, the summary statistics will be calculated for each NMP category (i.e. 0-5, 5-10 and 10-20% NMP).  

`r nrow(all_data) - nrow(data_nmp0_20)` surfaces have been filtered out, i.e. `r (nrow(all_data) - nrow(data_nmp0_20))/2` surfaces for each software package.  
